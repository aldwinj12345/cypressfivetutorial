...
//the purpose only for this is for the video to be extended to 10 seconds after a failed test
afterEach(function() {
...
describe('Login Page Test Suites',()=>{
    it('Test Company Logo: OrangeHRM Logo Image',()=>{
        ...
        cy.get(loginpage.orangehrmlogo, { timeout: 5000 })
          .should('be.visible')
          .should(([img])=>{
    ...
    it('Test Login Form Text Elements',()=>{
        cy.get(loginpage.loginformtitle).contains('Loginss')
